...
<body>
    ...
    ?>
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <input type="text" name="nombre" id="nombre" value="<?php echo $producto->getNombre(); ?> " readonly>

                <label for="descripcion">Descripcion</label>
                <input type="text" name="descripcion" id="descripcion" value="<?php echo $producto->getDescripcion(); ?>" readonly>

                <label for="precio">Precio</label>
                <input type="text" name="precio" id="precio" value="<?php echo $producto->getPrecio(); ?>" readonly>

                <label for="stock">Stock</label>
                <input type="text" name="stock" id="stock" value="<?php echo $producto->getStock(); ?>" readonly>
    ...
    <?php
        if(isset($_POST["Borrar"])) { 
            //include_once '../Controlador/ControladorProductos.php';
            //eliminarProducto();
            $productoB = new Producto($_POST["codigo"], $_POST["nombre"], $_POST["descripcion"], $_POST["precio"], $_POST["stock"],$_SESSION["proveedor"]);
            $_SESSION["productoB"] = $productoB;
    ?>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
